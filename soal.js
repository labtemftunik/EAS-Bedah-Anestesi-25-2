...
function tampilkanSoal(){
    ...
    for(let i=0;i<bankSoal.length;i++){
        ...
        <div class="card-soal">
            ...
            <h3>${i+1}. ${bankSoal[i].pertanyaan.replace(/\n/g, "<br>")}</h3>
...
async function koreksi(){
    ...
    await fetch("https://script.google.com/macros/s/AKfycbxX8tSnhfPMn0HTU0RCjPURtQxBI8uPpReWDwsIrxGmMJtalIw3iStvEEmNX7_wWKIriQ/exec",{
        method:"POST",
